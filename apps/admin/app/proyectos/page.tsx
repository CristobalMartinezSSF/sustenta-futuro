    ...
    <div className="min-h-screen" style={{ background: '#000000', color: '#F0F0F0' }}>
      ...
      <main className="px-6 py-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-white font-medium mb-2">Sin proyectos activos</h2>
          <p className="text-sm max-w-xs" style={{ color: 'rgba(240,240,240,0.35)' }}>
            Los proyectos aparecen aquí solo cuando una propuesta formal
            ha sido aprobada por el cliente.
          </p>
        </div>
      </main>
    </div>
